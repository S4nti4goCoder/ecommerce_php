...
class GetModel
{
	...
	✅ CORREGIDO: $searchArray[0] ahora usa placeholder :search0
	=============================================*/
	...
	static public function getDataSearch($table, $select, $linkTo, $search, $orderBy, $orderMode, $startAt, $endAt)
	{
		...
		// ✅ CORREGIDO: preparar valor del LIKE con placeholder
		$searchValue0 = "%" . $searchArray[0] . "%";
		...
		// ✅ CORREGIDO: LIKE usa :search0 en lugar de '%$searchArray[0]%'
		...
		if ($orderBy != null && $orderMode != null && $startAt == null && $endAt == null) {
			...
			$sql = "SELECT $select FROM $table WHERE $linkToArray[0] LIKE :search0 $linkToText ORDER BY $orderBy $orderMode";
		}
		...
		if ($orderBy != null && $orderMode != null && $startAt != null && $endAt != null) {
			...
			$sql = "SELECT $select FROM $table WHERE $linkToArray[0] LIKE :search0 $linkToText ORDER BY $orderBy $orderMode LIMIT $startAt, $endAt";
		}
		...
		if ($orderBy == null && $orderMode == null && $startAt != null && $endAt != null) {
			...
			$sql = "SELECT $select FROM $table WHERE $linkToArray[0] LIKE :search0 $linkToText LIMIT $startAt, $endAt";
		}

		$stmt = Connection::connect()->prepare($sql);

		// ✅ CORREGIDO: bindValue del placeholder :search0
		$stmt->bindValue(":search0", $searchValue0, PDO::PARAM_STR);
	...
	static public function getRelDataSearch($rel, $type, $select, $linkTo, $search, $orderBy, $orderMode, $startAt, $endAt)
	{
		...
		if (count($relArray) > 1) {
			...
			if ($orderBy != null && $orderMode != null && $startAt == null && $endAt == null) {
				...
				$sql = "SELECT $select FROM $relArray[0] $innerJoinText WHERE $linkToArray[0] LIKE :search0 $linkToText ORDER BY $orderBy $orderMode";
			}
			...
			if ($orderBy != null && $orderMode != null && $startAt != null && $endAt != null) {
				...
				$sql = "SELECT $select FROM $relArray[0] $innerJoinText WHERE $linkToArray[0] LIKE :search0 $linkToText ORDER BY $orderBy $orderMode LIMIT $startAt, $endAt";
			}
			...
			if ($orderBy == null && $orderMode == null && $startAt != null && $endAt != null) {
				...
				$sql = "SELECT $select FROM $relArray[0] $innerJoinText WHERE $linkToArray[0] LIKE :search0 $linkToText LIMIT $startAt, $endAt";
			}
	...
	✅ CORREGIDO: $between1, $between2 e $inTo usan placeholders
	=============================================*/
	...
	static public function getDataRange($table, $select, $linkTo, $between1, $between2, $orderBy, $orderMode, $startAt, $endAt, $filterTo, $inTo)
	{
		...
		// ✅ CORREGIDO: $inTo se sanitiza como array de enteros
		// Evita inyección tipo: "1) OR 1=1--"
		$filter = "";
		$inToPlaceholders = "";

		if ($filterTo != null && $inTo != null) {

			$inToArray = array_map('intval', explode(",", $inTo));
			$inToPlaceholders = implode(",", $inToArray);
			$filter = "AND $filterTo IN ($inToPlaceholders)";
		}
		...
		// ✅ CORREGIDO: $between1 y $between2 usan :between1 y :between2
		...
		// ✅ CORREGIDO: bind de :between1 y :between2
