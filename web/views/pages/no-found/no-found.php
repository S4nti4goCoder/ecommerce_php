        ...
        <section class="content pb-5">
            <div class="error-page">
                ...
                <div class="error-content">
                    <h3><i class="fas fa-exclamation-triangle text-default" style="color: #00a6fb;"></i> Oops! No hay productos por ahora..</h3>
                    <p>
                        No pudimos encontrar los productos que estás buscando.
                        <a href="/"><strong>regresar a la página de inicio</strong></a>.
                    <p>
                </div>
            </div>
        </section>
