...
<div class="container py-3 pb-5">
    <div class="row row-cols-1 row-cols-sm-2 row-cols-md-6">
        <div class="col text-center">
            <h3 class="col text-center">Colombia</h3>
        ...
        <div class="col text-center">
            <h3 class="col text-center">México</h3>
        ...
        <div class="col text-center">
            <h3 class="col text-center">Perú</h3>
        ...
        <div class="col text-center">
            <h3 class="col text-center">España</h3>
