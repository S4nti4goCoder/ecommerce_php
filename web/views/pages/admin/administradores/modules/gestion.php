                    ...
                    <div class="container">
                        <div class="row">
                            ...
                            <div class="col-12 col-lg-6 mt-2 d-none d-lg-block">
                                ...
                                <a href="/admin/administradores" class="btn btn-default float-right py-2 px-3 btn-sm mr-2">Regresar</a>
                            </div>
                            <div class="col-12 text-center d-flex justify-content-center mt-2 d-block d-lg-none">
                                <div>
                                    <a href="/admin/administradores" class="btn btn-default py-2 px-3 btn-sm mr-2">Regresar</a>
                                </div>
                                <div>
