...
<?php else: ?>
	...
	<div class="container pt-3 pb-5">
		...
		<div class="tab-content border-bottom border-left border-right">
    		...
    		<div class="tab-pane container <?php if (!isset($routesArray[1])): ?> active <?php else: ?> fade <?php endif ?> <?php if (isset($routesArray[1]) && $routesArray[1] == "shopping" ): ?> active <?php endif ?>" id="shopping">
