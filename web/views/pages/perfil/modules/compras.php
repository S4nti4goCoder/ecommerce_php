                            ...
                            <?php if ($value->type_variant == "gallery"): ?>
                                ...
                                <div class="container">
                                    <ul class="timeline-3">
                                        ...
                                        <li class="<?php if ($value->process_order > 0): ?> text-dark <?php else: ?> text-light<?php endif ?>">
                                        ...
                                        <li class="<?php if ($value->process_order > 1): ?> text-dark <?php else: ?> text-light<?php endif ?>">
